package com.jamesbulpin.bluefruit.le.connect.app.neopixel;
...
import com.jamesbulpin.bluefruit.le.connect.BuildConfig;
import com.jamesbulpin.bluefruit.le.connect.R;
import com.jamesbulpin.bluefruit.le.connect.app.CommonHelpFragment;
import com.jamesbulpin.bluefruit.le.connect.app.ConnectedPeripheralFragment;
import com.jamesbulpin.bluefruit.le.connect.ble.BleUtils;
import com.jamesbulpin.bluefruit.le.connect.ble.central.BlePeripheralUart;
import com.jamesbulpin.bluefruit.le.connect.ble.central.UartPacketManager;
import com.jamesbulpin.bluefruit.le.connect.utils.DialogUtils;
import com.jamesbulpin.bluefruit.le.connect.utils.FileUtils;
import com.jamesbulpin.bluefruit.le.connect.utils.MetricsUtils;
import com.jamesbulpin.bluefruit.le.connect.utils.TwoDimensionScrollView;
