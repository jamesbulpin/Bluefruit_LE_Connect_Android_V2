package com.jamesbulpin.bluefruit.le.connect.app;
...
import com.jamesbulpin.bluefruit.le.connect.R;
import com.jamesbulpin.bluefruit.le.connect.ble.BleUtils;
import com.jamesbulpin.bluefruit.le.connect.ble.central.BlePeripheral;
import com.jamesbulpin.bluefruit.le.connect.ble.central.BleScanner;
import com.jamesbulpin.bluefruit.le.connect.style.RssiUI;
import com.jamesbulpin.bluefruit.le.connect.utils.AdapterUtils;
import com.jamesbulpin.bluefruit.le.connect.utils.KeyboardUtils;
import com.jamesbulpin.bluefruit.le.connect.utils.LocalizationManager;
import com.jamesbulpin.bluefruit.le.connect.utils.UriBeaconUtils;
...
import static com.jamesbulpin.bluefruit.le.connect.ble.central.BleScanner.kDeviceType_Beacon;
import static com.jamesbulpin.bluefruit.le.connect.ble.central.BleScanner.kDeviceType_Uart;
import static com.jamesbulpin.bluefruit.le.connect.ble.central.BleScanner.kDeviceType_UriBeacon;
